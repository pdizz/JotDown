...
<input type="text" name="title" value="<?php echo $this->session->flashdata('title'); ?>" id="title" maxlength="64"  />
<textarea name="notes" cols="85" rows="30" id="notes" ><?php echo $this->session->flashdata('notes'); ?></textarea>
