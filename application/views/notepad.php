...
$notes = $this->session->flashdata('notes');
...
?>
    ...
    <input type="text" name="title" value="<?php echo $title; ?>" id="title" maxlength="64"  />
    <textarea name="notes" cols="85" rows="30" id="notes" ><?php echo $notes; ?></textarea>
